...
class GruposControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grupo" do
    assert_difference('Grupo.count') do
      post grupos_url, params: { grupo: { facultad_id: @grupo.facultad_id, nombre: @grupo.nombre } }
    end
  ...
  test "should update grupo" do
    patch grupo_url(@grupo), params: { grupo: { facultad_id: @grupo.facultad_id, nombre: @grupo.nombre } }
